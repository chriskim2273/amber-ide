...
function App(): JSX.Element {
  ...
  const [kind, setKind] = useState<'shell' | 'claude' | 'grok' | 'codex' | 'opencode' | 'pi' | 'browser' | 'editor'>('shell')
  ...
  return (
    <div className={mobile ? 'app mobile' : 'app'}>
      ...
      <div className="toolbar">
        ...
        <select className="select" value={kind} onChange={(e) => setKind(e.target.value as 'shell' | 'claude' | 'grok' | 'codex' | 'opencode' | 'pi' | 'browser' | 'editor')}>
