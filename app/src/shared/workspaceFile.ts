...
export interface SavePane { name: string; cwd: string; kind: string; ord: number; path?: string | null; title?: string | undefined }
...
export function buildLoadPlan(doc: WorkspaceDoc, opts: LoadOptions): LoadPlan {
  ...
  return { creates, workspaces, frozen, scrollback, browserRails, browserRecovery, editors, titles, targetWorkspaces }
}
